...
Источник статусов "проверено по коду" на 2025-12-30.
...
| 2 | B-02.3 Tray UX: AutoConvert toggle и меню | qqrm | ✅ done | реализовано | ЛКМ по иконке: toggle AutoConvert. ПКМ: контекстное меню с AutoConvert ON/OFF, Show/Hide, Exit. Double click: show/hide окна |
...
|:--:|:------|:------:|:----|
| B-01.1 | Применять runtime и config на старте (autostart, delay, hotkeys) | 🧱 todo | После старта runtime и UI соответствуют сохраненному config, автозапуск синхронизирован |
...
| ID | Задача | Статус | DoD |
|:--:|:------|:------:|:----|
| B-02.3 | Ожидаемый Tray UX | ✅ done | ЛКМ: toggle AutoConvert. ПКМ: контекстное меню без показа окна. Double click: show/hide окна. Меню содержит AutoConvert ON/OFF (с отметкой текущего), Show/Hide, Exit |
